...
//                 <Input type="text" className="guessLetter" maxLength="1"  placeholder="Guess a letter"/> 
//                 <FormBtn type="submit" className="guessButton">Guess</FormBtn>
//                 </form>  
//                 <div className="wrong">
...
//                   <p className="text"></p>
//                   <FormBtn className="restart button">Play Again?</FormBtn>
